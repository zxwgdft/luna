package com.luna.his.schedule.service;
...
import com.luna.his.schedule.mapper.ScheduleMapper;
    ...
    public WeekScheduleVO getWeekSchedule(ScheduleQuery query) {
        ...
        List<Employee> employees = employeeService.findSimpleList(
                new LambdaQueryWrapper<Employee>()
                        ...
                        .eq(query.getDepartId() != null, Employee::getDepartId, query.getDepartId())
        );
