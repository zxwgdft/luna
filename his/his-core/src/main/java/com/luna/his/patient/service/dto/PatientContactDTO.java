...
public class PatientContactDTO {
	...
	@ApiModelProperty("微信")
	@Size(max = 20, message = "微信长度不能大于20")
	private String weixin;

	@ApiModelProperty("QQ")
	@Size(max = 15, message = "QQ长度不能大于15")
	private String qq;

	@ApiModelProperty("手机1")
	@Size(max = 15, message = "手机1长度不能大于15")
	private String mobile1;

	@ApiModelProperty("手机1属性")
	@Size(max = 5, message = "手机1属性长度不能大于5")
	private String mobile1re;

	@ApiModelProperty("手机2")
	@Size(max = 15, message = "手机2长度不能大于15")
	private String mobile2;

	@ApiModelProperty("手机2属性")
	@Size(max = 5, message = "手机2属性长度不能大于5")
	private String mobile2re;

	@ApiModelProperty("手机3")
	@Size(max = 15, message = "手机3长度不能大于15")
	private String mobile3;

	@ApiModelProperty("手机3属性")
	@Size(max = 5, message = "手机3属性长度不能大于5")
	private String mobile3re;

	@ApiModelProperty("电话1")
	@Size(max = 15, message = "电话1长度不能大于15")
	private String phone1;

	@ApiModelProperty("电话1属性")
	@Size(max = 5, message = "电话1属性长度不能大于5")
	private String phone1re;

	@ApiModelProperty("电话2")
	@Size(max = 15, message = "电话2长度不能大于15")
	private String phone2;

	@ApiModelProperty("电话2属性")
	@Size(max = 5, message = "电话2属性长度不能大于5")
