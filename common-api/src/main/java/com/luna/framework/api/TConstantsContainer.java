...
public interface TConstantsContainer {
     ...
     */
    Map<String, List<TConstant>> getTypeTConstants(String... typeCodes);
     ...
     */
    List<TConstant> getTypeTConstant(String typeCode);
     ...
     */
    TConstant getTConstantByValue(String typeCode, String value);
     ...
     * @param key      常量key
     */
    TConstant getTConstantByKey(String typeCode, String key);
